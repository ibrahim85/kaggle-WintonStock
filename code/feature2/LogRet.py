...
if __name__ == '__main__':
    ...
    for i in range(2,121):
        Ret = "Ret_"+str(i)+"_p"
        Rets.append(Ret)
    train[Rets].to_csv("../../data/new/train_ts_rate.csv")
    test[Rets].to_csv("../../data/new/test_ts_rate.csv")
    ...
    train[Rets].to_csv("../../data/new/train_ts_price.csv")
    test[Rets].to_csv("../../data/new/test_ts_price.csv")
